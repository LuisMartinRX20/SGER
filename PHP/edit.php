...
<body>
	...
	<div class="container">
		<div class="content">
            ...
            $miConsulta = "select * from empleados where codigo='{$_GET["nik"]}'"; 
			...
			if(isset($_POST['save'])){
                ...
                $miConsulta = "UPDATE empleados set codigo='$codigo', nombres='$nombres',lugar_nacimiento='$lugar_nacimiento',fecha_nacimiento='$fecha_nacimiento',direccion='$direccion',telefono='$telefono',puesto='$puesto',estado='$estado' where codigo='$nik' "; //Crear el UPDATE para el campo codigo igual a variable $nik
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="empleados.php" class="btn btn-sm btn-danger">Cancelar</a>
					</div>
				</div>
			</form>
		</div>
