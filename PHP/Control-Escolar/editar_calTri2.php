	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
                ...
                $miConsulta = "UPDATE calificaciones set calif_P3='$cal' where id_materia='$id' "; //Crear el UPDATE para el campo codigo igual a variable $nik
			...
			<form class="form-horizontal" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="cal" value="<?php echo $row['calif_P3']; ?>" class="form-control" placeholder="Calificacion" required>
                    </div>
                </div>
